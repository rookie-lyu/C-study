...
41.socket 编程
42.路由信息协议 RIP(RoutingInformationProtocol)
...
43.开发最短路径优先 OSPF（OpenShortestPathFirst）
...
44.边界网关协议 BGP（Bordergatewayprotocol）
...
46.不同自治系统之间的路由选择为什么不能使用前面讨论过的内部
网关协议？
...
50.网络地址转换 NAT（NetworkAdressTranslation）
